...
class ChangeEmployeeDialog extends Dialog {
  ...
  ChangeEmployeeDialog(this.employee, {Key? key}) : super(key: key);
  ...
  Future<void> save(BuildContext context) async {
    ...
    Dio().request(
        "http://localhost:9101/changeEmployee",
        data: {
          'rid': employee['rid'],
          'eid': employee['eid'],
          'sex': employee['sex'] == '男' ? 1 : 0,
          'location': location,
          'salary': salary,
          'name': name,
        },
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            height: 35,
                                            child: TextFormField(
                                              initialValue: employee['sex'] == 1 ? '男' : '女',
                                          ...
                                          SizedBox(
                                            height: 35,
                                            child: TextFormField(
                                              initialValue: employee['location'],
